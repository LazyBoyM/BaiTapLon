    ...
    <div className="space-y-12 md:space-y-24 pb-12 md:pb-24 overflow-hidden">
      ...
      <section className="relative pt-12 md:pt-24 pb-16">
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-2xl text-slate-500 leading-relaxed max-w-2xl mx-auto font-normal">
              Kho giao diện, mã nguồn, khóa học và sản phẩm số chất lượng cao
              được kiểm duyệt khắt khe dành cho nhà phát triển và sáng tạo.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                to="/products"
                className="btn-apple-primary text-lg px-9 py-4 w-full sm:w-auto shadow-xl"
              >
              ...
              {!isAuthenticated ? (
                <Link
                  to="/register"
                  className="btn-apple-secondary text-lg px-9 py-4 w-full sm:w-auto"
                >
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[700px] pointer-events-none -z-10 overflow-hidden">
          ...
          <div
            className="absolute top-[100px] right-[10%] w-[500px] h-[500px] bg-gradient-to-tl from-purple-400/25 to-pink-500/25 rounded-full blur-[130px] animate-pulse-glow"
      ...
      <section className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={i}
              className="card-apple p-8 flex flex-col justify-between space-y-6 bg-white border border-slate-100/80 relative overflow-hidden group"
            >
              <div className="space-y-4">
                <div
                  className={`w-14 h-14 rounded-2xl flex items-center justify-center border transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6 ${f.bg}`}
                >
                  {f.icon}
                </div>
      ...
      <section className="container-custom space-y-10">
        ...
        {loading ? (
          <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div
                key={i}
                className="aspect-[4/5] bg-slate-200/60 animate-pulse rounded-[var(--apple-radius)]"
              />
            ))}
          </div>
        ...
        <div className="text-center pt-6">
          <Link
            to="/products"
            className="btn-apple-secondary px-8 py-3.5 text-sm font-bold shadow-sm hover:shadow"
          >
            Xem toàn bộ sản phẩm trong cửa hàng{" "}
      ...
      <section className="container-custom">
        <div className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 rounded-[32px] p-8 md:p-16 text-white relative overflow-hidden">
          <div className="max-w-2xl mx-auto text-center space-y-4 mb-12 relative z-10">
            <span className="text-blue-400 text-xs font-extrabold uppercase tracking-widest">
              Đánh giá thực tế
            </span>
            <h2 className="text-3xl md:text-4xl font-black tracking-tight text-white">
              Khách hàng & Nhà phát triển nói gì?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
            {[
              {
                quote:
                  "Tốc độ phản hồi cực kỳ nhanh nhạy. Giao diện mượt mà tuyệt đối kể cả trên thiết bị di động.",
              ...
              {
                quote:
                  "Kiến trúc Microservices kết hợp CI/CD tự động giúp việc tải code và triển khai diễn ra chỉ trong vài giây.",
              ...
              {
                quote:
                  "Mua sản phẩm số và tải xuống lập tức không hề gián đoạn. Giao dịch an toàn, rõ ràng.",
              ...
              <div
                key={idx}
                className="bg-white/10 backdrop-blur-md border border-white/10 p-6 rounded-2xl space-y-4"
              >
        ...
        <div className="relative overflow-hidden rounded-[36px] bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-8 py-20 md:px-20 md:py-24 text-center shadow-2xl shadow-blue-500/20">
          <div className="relative z-10 space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-blue-100 text-lg md:text-xl max-w-xl mx-auto font-normal">
              Khám phá hàng ngàn tài nguyên số cao cấp và tự động hóa quy trình
              kinh doanh của bạn ngay hôm nay.
            </p>
            <div className="pt-2">
              <Link
                to={isAuthenticated ? "/products" : "/register"}
                className="inline-flex items-center gap-2 bg-white text-slate-900 hover:bg-slate-100 font-extrabold text-lg px-10 py-4 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95"
              >
                {isAuthenticated
